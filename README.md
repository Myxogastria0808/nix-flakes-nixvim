...
| **Syntax**         | [nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter)                                                                                 | 33-parser set — highlighting + indent                                                                                                                                                          |
...
| Docker Compose      | docker_compose_language_service | prettier                         | ✓          | `docker-compose.yml` is detected as `yaml` filetype; Treesitter `yaml` grammar applies (no dedicated docker-compose grammar). conform's `yaml = ["prettier"]` applies for formatting                                                                                             |
