...
| **Icons**          | [nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons)                                                                                   | Custom icons for `.lean` (∀), `lean-toolchain` (∃), `.typ` (𝐭), `.agda` (󱗆), `.mmd` (󰒪), `.envrc/.bashrc/.zshrc` ($)                                                                          |
...
| **Syntax**         | [nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter)                                                                                 | 37-parser set — highlighting + indent                                                                                                                                                          |
...
│       │   └── treesitter.nix       # Syntax highlighting (nvim-treesitter, 37 parsers)
│       └── action/
